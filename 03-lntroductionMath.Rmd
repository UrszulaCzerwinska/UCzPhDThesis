...
In Unsupervised learning is given the data and is asked to divide the data given a particular constraint. However, the correct division of the data is not known. Therefore an unsupervised algorithm aims to unveil the "hidden structure" of the data or latent variables.
...
> Deconvolution : *the resolution of a convolution function into the functions from which it was formed to separate their effects* 
