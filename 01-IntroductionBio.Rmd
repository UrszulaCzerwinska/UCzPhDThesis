...
#### Two-faced nature of immune cells 
 ...
 In the 1960s, the immune surveillance theory hypothesised "the ability to identify and destroy nascent tumors as a central asset of the immune system" [@Sebeok1976; @Burnet1970], but it was hihly criticised in consequence of no increase in tumor incidence in athymic nude mice [@Stutman1974; Rygaard1976]. Later it was shown, that this mice model was not adequate [@Cavallo2011]. Over the years, it was shown that the immune surveillance theory was not wrong, but was not completely right neither.
...
A plethora of different computational methods have been developed in order to further characterise tumor samples using different factors. We mention here mainstream methods that cover different approaches of scoring the TME-cancer phenotype. 
...
@Charoentong claim that the immunophenoscore can predict response to CTLA-4 and anti-PD-1.
