...
\begin{quote}
*to empower the students to take initiative and develop their own
research projects **at the crossroads of life, learning, and digital
sciences.* \citep{CRIweb}
\end{quote}
...
interdisciplinary efforts are nicely described by (\citet{Ledford2015}).
...
\begin{quote}
*There's a huge push to call your work interdisciplinary,'' says David
Wood, a bioengineer at the University of Minnesota in Minneapolis. ``But
there's still resistance to doing actual interdisciplinary science.*
\end{quote}
...
affected equally? From the chart \ref{fig:interdisciplinary}) we can see
that Social Studies of Medecine seems to be the most interdisciplinary
field. In general Biology, Health and Biomedical Sciences seem to be
more open into flow of knowledge from other fields than humanities. On
the extreme opposite of health, Clinical Medecine appears to be very
conservative field.
...
In parallel, I worked on exploration of brand new data type: single cell
transcriptomic (RNAseq) in the context of tumor microenvironment.
...
irritation. \citep{Virchow1847}}\label{fig:Virchov-cell}
\end{figure}
...
\begin{quote}
When a plant goes to seed, its seeds are carried in all directions, but
