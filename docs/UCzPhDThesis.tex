...
Thanks to all people I worked with in both teams: Arnau, Pauline, Gaelle, Paul, Cristobal, Luca, Laura, Laurence, Loredana, Jonas, Floriane, Maude, Philemon, Lilith, Paula, Michaly, Louis. To my FdV mates: Roberta, Juanma, Miza, Guillermo, and others.

This work would never be possible without help and patience of my family, my partner Arnaud and his family. Especially, I would like to thank Arnaud, who managed to be with me on the daily basis, spent the endless hours correcting my writing and speaking, discussed about the code and good practices, made available a computer server at home, offered me a roof and internet connection at affordable price, was making me laugh when I was coming home tired, angry or unmotivated, and just for being him adorable self. This thesis is dedicated to his father that will never profit from breakthrough in cancer research. 
...
\textbf{A}tals of \textbf{C}ancer \textbf{S}ingnaling
...
\textbf{CAF}\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
\textbf{C}ancer \textbf{A}ssociated \textbf{F}ibriblasts\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.14\columnwidth}\raggedright
\textbf{CNA}\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
\textbf{Dencon}volution of omic data through \textbf{I}mmune
...
The piece of work you are reading should harvest the fruit of an
...
effort. This is even truer in the era of big data, when the demand for
quantitative tools is exponentially growing, in order to extract
...
knowledge of different specialties: multidisciplinarity which is a sum
of efforts of different disciplines and interdisciplinarity that allows
profiting from the synergy of multiple disciplines (Fig.
...
engage exchange between students of different faculties, he encounters a
lot of reluctance.
...
Technology. However, recruiting an open-minded director to lead this
...
disciplines is necessary. Finally, developing an interdisciplinary
research is extremely challenging as it often requires extra effort from
an apprentice.
...
\emph{How did interdisciplinarity change over years? Are all disciplines
affected equally?}
...
project to a success. I recognize that the immune systems are is very
complex and dynamic system and many years of expertise are needed to
really grasp an understanding of it. I had a great chance to work hand
...
faced an important problem of lack of gold standard validation data that
...
In a parallel project, I worked on an exploration of brand new data
...
analyzing pDC subsets of X cancer \protect\hyperlink{annexe2}{Annexe2}.
Some others are in still preparation.

I have attended X national and international conferences, where I
...
(\textgreater{}300 hours) training over 3 years, I am equipped with soft
skills that not only helped me to shape my thesis project on the go but
also, I hope, will help me to succeed in my future career path.
...
present results of an application of DeconICA and other tools to
\textgreater{}100 transcriptomic datasets (see
\protect\hyperlink{results}{Chapter 7}). The second part of results is
dedicated to my work on cell type heterogeneity (see
\protect\hyperlink{map}{Chapter 8}). The manuscript finishes with
\protect\hyperlink{discussiongenerale}{Chapter 9} and
...
with the topic of this thesis. At the end I included a glossary of
useful terms.
...
\item
  ...
  \end{itemize}
\item
  Scientific CV (including list of attended conferences and
  publications)
\end{itemize}
...
normalised + labels\strut
\end{minipage} & \begin{minipage}[t]{0.05\columnwidth}\raggedright
\url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE98638}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright
\strut
\end{minipage} & \begin{minipage}[t]{0.05\columnwidth}\raggedright
\strut
...
\emph{Publication accepted in Nature Immunology on 11th May 2018}
(Abstract)
...
\includepdf[pages={1-}, scale=1]{pdf-ext/Micheaetal.pdf}
