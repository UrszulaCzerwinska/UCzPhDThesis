...
\large{\centerline{This thesis is also available online as a webpage at the address \url{http://urszulaczerwinska.github.io/UCzPhDThesis}. The web version contains interactive content (videos, figures, tables) that are static in the pdf version. Enjoy!}
